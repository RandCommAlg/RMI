...
doc ///
 ...
 Description
  ...
  Text
   ...
   If Strategy=>"ER", the default setting for the graded fixed number of generators version of the method, the set of monomials we obtain will not necessarily be minimal.
