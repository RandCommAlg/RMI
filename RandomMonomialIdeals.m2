...
doc ///
 ...
 Description
  ...
  Text
   Observe that there are at most one degree-1 monomials, one degree-2 monomial, and one degree-3 monomial. Also observe that Strategy=>"Minimal" generally gives more generators than the default Strategy=>"ER".
