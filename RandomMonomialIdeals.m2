...
doc ///
 ...
 Description
  Text
   ...
   (preprint available at  @HREF"https://arxiv.org/abs/1701.07130"@). The package also generalizes .... ****TO DO **** [fixed $M$ stuff, which isn't in the paper.]
  ...
  Example
   ...
   --statistics(sample(ER(CC[z_1..z_8],5,0.1),100))
  Text
